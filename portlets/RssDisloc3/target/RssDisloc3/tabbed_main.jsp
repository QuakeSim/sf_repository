...
function TapAccess(index){
      ...
      var s = '<iframe scrolling="yes" width=100% height="700" frameborder="1" src="http://129.79.49.68:8080/RssDisloc3/' + index + '.faces?email=<%=session.getAttribute("email")%>"></iframe>'
...
<iframe scrolling="yes" width=100% height="700" frameborder="1" src="http://129.79.49.68:8080/RssDisloc3/LoadProject.faces?email=<%=session.getAttribute("email")%>"></iframe>
</div>
