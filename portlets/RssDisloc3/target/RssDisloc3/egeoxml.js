...
'<input type="checkbox" id="li_' + url_bits[0] + '_1"' + ' onchange="' + this.myvar + '.togglechboxofAllOverlays(' + '\'' + url_bits[0] + '_1\',' + this.overlaycounter + ')" checked/>' + 
'<input type="checkbox" id="li_' + url_bits[0] + '_2"' + ' onchange="' + this.myvar + '.togglechboxofAllOverlays(' + '\'' + url_bits[0] + '_2\',' + this.overlaycounter + ')" checked/>' +
'<input type="checkbox" id="li_' + url_bits[0] + '_3"' + ' onchange="' + this.myvar + '.togglechboxofAllOverlays(' + '\'' + url_bits[0] + '_3\',' + this.overlaycounter + ')" checked/>' +  
'<input type="checkbox" id="li_' + url_bits[0] + '"' + ' onchange="' + this.myvar + '.togglechboxofAllOverlays(' + '\'' + url_bits[0] + '\',' + this.overlaycounter + ')" checked/>' + url_bits[0];
	  that.side_bar_html += '<ul>';

	  for (var i=this.overlaycounter; i<that.side_bar_list.length; i++) {	  
	    var bits = that.side_bar_list[i].split("$$$",4);
	    that.side_bar_html += '<li>'+
'<input type="checkbox" name="' + url_bits[0] + '_1_overlays"' + 'id="' + url_bits[0] + '_1_overlays_' + (i-this.overlaycounter) + '"' + ' onchange="' + this.myvar + '.togglechboxofOverlay(' + '\'' + url_bits[0] + '_1\',' + i + ',' + this.overlaycounter + ')" checked/>' +
'<input type="checkbox" name="' + url_bits[0] + '_2_overlays"' + 'id="' + url_bits[0] + '_2_overlays_' + (i-this.overlaycounter) + '"' + ' onchange="' + this.myvar + '.togglechboxofOverlay(' + '\'' + url_bits[0] + '_2\',' + i + ',' + this.overlaycounter + ')" checked/>' +
'<input type="checkbox" name="' + url_bits[0] + '_3_overlays"' + 'id="' + url_bits[0] + '_3_overlays_' + (i-this.overlaycounter) + '"' + ' onchange="' + this.myvar + '.togglechboxofOverlay(' + '\'' + url_bits[0] + '_3\',' + i + ',' + this.overlaycounter + ')" checked/>' +
'<input type="checkbox" name="' + url_bits[0] + '_overlays"' + 'id="' + url_bits[0] + '_overlays_' + (i-this.overlaycounter) + '"' + ' onchange="' + this.myvar + '.togglechboxofOverlay(' + '\'' + url_bits[0] + '\',' + i + ',' + this.overlaycounter + ')" checked/>' + that.sidebarfn(that.myvar,bits[0],bits[1],bits[2],bits[3]) + '</li>';
	  }
	...
	if (that.opts.off) {
	  document.getElementById('li_' + url_bits[0]).click();
	    ...
	    document.getElementById('li_' + url_bits[0] + '_3').click();
	  }
	}
      }
