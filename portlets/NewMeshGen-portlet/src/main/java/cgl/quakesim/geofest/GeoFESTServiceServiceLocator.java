...
public class GeoFESTServiceServiceLocator extends org.apache.axis.client.Service implements cgl.quakesim.geofest.GeoFESTServiceService {
    ...
    private java.lang.String GeoFESTExec_address = "http://localhost:8080/geofestexec/services/GeoFESTExec";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8080/geofestexec/services/GeoFESTExec", "GeoFESTServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8080/geofestexec/services/GeoFESTExec", "GeoFESTExec"));
        }
