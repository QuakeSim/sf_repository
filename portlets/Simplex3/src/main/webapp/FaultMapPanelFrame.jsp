<h:panelGrid id="FaultMapPanelFrame"
				 columns="1"
...
var border, marker_NE, marker_SW;
var faultMap=null;
...
//--------------------------------------------------
// Define the listener for map clicks on polylines.
//--------------------------------------------------
...
});  //This ends the DOM Listener call back.
...
function togglefaultname(t) {
	 ...
	 if (flistpolyline[prefix[1]]) {
		  ...
		  //This may be dead code.  Not sure.
