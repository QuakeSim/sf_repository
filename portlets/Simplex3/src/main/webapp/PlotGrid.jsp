     ...
     <f:view>    
      <h:form>
       <h:dataTable id="projectlist"
        ...
        <h:column>
         <f:facet name="header">
          <h:outputText  id="kjb132623d" escape="false" value="Creation Date" />
         </f:facet>
        ...
        <h:column>
         <f:facet name="header">
          <h:outputText id="blah1er8er" escape="false" value="Select" />
         </f:facet>
         <h:panelGroup id="pgselect34cd">
          <h:commandButton id="SelectProject" value="Plot" actionListener="#{SimplexBean.togglePlotProject}"/>
         </h:panelGroup>
        </h:column> 
       </h:dataTable>
      </h:form>
