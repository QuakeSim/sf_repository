...
*  see http://earthcode.com/blog/2006/07/gzoom.html
*
...
function DragZoomControl(opts_boxStyle, opts_other, opts_callbacks) {
  ...
  this.globals.options={
    buttonHTML: 'dragzoom',
    buttonHTML: '<center><img src="sar-zoom-button.png"></center>',
    buttonStartingStyle: 
      {width: '54px', border: '1px solid black', padding: '2px'},
    buttonStyle: {background: '#FFF'}, // 9BC for ocean color
    backButtonHTML: 'zoom back',
    backButtonStyle: {background: '#FFF', display: 'none'},
    buttonZoomingHTML: '<font size=-1>To zoom, drag a region on the map</font>',
    buttonZoomingStyle: {background: '#FFF'},
...
DragZoomControl.prototype.getRectangle_ = function(startX, startY, pos, ratio){
  ...
  return {
    ...
    // NEW revised for no fixed aspect ratio:
    endX: startX + dX,
    endY: startY + dY,
    width: dX,
    height: dY,
