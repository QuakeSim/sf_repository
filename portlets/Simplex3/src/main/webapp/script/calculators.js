var calculators=calculators || (function() {
	 ...
	 function updateLat0Lon0Lat1Lon1(origLat, origLon, xstart, ystart,latStart, lonStart, latEnd, lonEnd, strike, dipAngle, length){
		  ...
		  lonStart.value=Math.round(lonStart.value*1000.0)/1000.0;
		  ...
		  if (strike.value == 0) {
				...
				var sval = 90 - strike.value;  //Note strike is the angle measured from North (y-axis).
	 ...
	 function updateXYLengthStrike(origLat, origLon, xstart, ystart,latStart, lonStart, latEnd, lonEnd, strike, dipAngle, length){
		  ...
		  xstart.value=Math.round(xstart.value*1000.0)/1000.0;
		  ystart.value=(latStart.value-origLat.value)*111.32;
		  ystart.value=Math.round(ystart.value*1000.0)/1000.0;
		  ...
		  strike.value=Math.round(strikeValue*1000.0)/1000.0;
