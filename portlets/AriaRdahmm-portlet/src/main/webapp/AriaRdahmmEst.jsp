...
<%
	...
	String xmlUrl = "http://aria.xml.access.hostname/ariaResEst30MinMar15/station-state-change-ARIA-est.xml";
	String stationListUrl = "http://local.hostname/ariaResEst30MinMar15/stationList.txt";
	if (dataSource.equalsIgnoreCase("30MinMar26")) {
		xmlUrl = "http://aria.xml.access.hostname/ariaResEst30MinMar26/station-state-change-ARIA-estMar26.xml";
		stationListUrl = "http://local.hostname/ariaResEst30MinMar26/stationList.txt";
	} else if (dataSource.equalsIgnoreCase("5MinMar11")) {
		xmlUrl = "http://aria.xml.access.hostname/ariaResEst5MinMar11/station-state-change-ARIA-est5MinMar11.xml";
		stationListUrl = "http://local.hostname/ariaResEst5MinMar11/stationList.txt";
	}
%>
...
<body>
	...
	<style>
		#yahooCalContainer {position:relative; width:210px;}
		#slider-bg { 
			position: relative; 
	...
	<table width="1164" cellPadding="0">
		<tr>
			<td width="1164" colspan="3">
		...
		<tr>
			<td valign="top" width="220">
				<table cellPadding="0">
					<tr><td>
						<table border='1' width="220" cellPadding="0">
							<tr>
								<td><b>Status</b></td>
								<td nowrap><b>Icon Color<b></td>
							</tr>
							<tr>
					...
					<tr><td><div id="yahooCalContainer" align="center"/></td></tr>
					<tr><td>
					...
					<tr><td><button id="getKmlBtn" onClick="getKmlBtnClick(this)">Get KML for selected Date</button></td></tr>
					<!-- tr><td>Or choose a time by dragging the slider under the map.</td></tr -->
				</table>
			</td>
			<td>
				<div id="mapDiv" style="width: 744px; height: 600px"></div>
			</td>
			<td valign="top" width="200">
				<table cellPadding="0">
					<tr><td><b>Select a station:</b></td></tr>
					<tr><td><select id="stationSelect" style="width:150px" selectedIndex=0></td></tr>
					<tr><td><button id="selectStationBtn" onClick="selectStationBtnClick(this)" style="width:150px">Show Information</button></td></tr>
					<tr><td><br/></td></tr>
					<tr><td><b>Station Detailed Data:</b></td></tr>
					<tr><td><div id="stationDetailDiv"></div></td></tr>
				</table>
			</td>
		</tr>
	</table>
...
<script type="text/javascript">
	...
	function markerClickBody(marker, selectedStation) {
		...
		var outputTable = "<table border='0'>" 
							...
							+ "</table>";
		document.getElementById("stationDetailDiv").innerHTML = outputTable;
	}
	...
	quakeSimDiv.innerHTML = "<img src='http://local.hostname/AriaRDAHMMEst/QuakeSimLogoGrayEmboss.png'/>";
	...
	var resServiceUrlPrefix = "http://local.hostname/axis2/services/AriaRdahmmResultService/";
	...
	function onMapMoveBody() {
		...
		<table width="1164">
			<tr><td>
				...
				All original GEONET RINEX data provided to Caltech by the Geospatial Information Authority (GSI) of Japan.</font></p>
			</td></tr>
			<tr><td>
				<p><font face="Verdana" size="2">Time series segmentation performed by the QuakeSim Project using RDAHMM.</font></p>
			</td></tr>
		</table>
</body>
</html>
