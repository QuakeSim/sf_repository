		  ...
		  <h:panelGrid id="pgridmain" columns="1" border="0">
			 ...
			 <h:outputText id="dosomework" 
								...
								value="You have the following archived disloc runs. Click the 
										 ...
										 save directly to your desktop, click your mouse's right 
			 ...
			 <h:dataTable id="DislocOutputPanel3" var="summaryBean"
				...
				<h:column>
				  ...
				  <h:panelGroup id="pgkml">
					 ...
					 <h:outputLink id="linkdre6" 
										value="http://maps.google.com/maps?q=#{summaryBean.kmlurl}&t=p" 
										target="_blank">
						<h:outputText id="blaheoru17" 
										  escape="false" 
										  value="[<font size=1px>View In Google map</font>]" />
					 </h:outputLink>
				  </h:panelGroup>
				</h:column>					
				...
				<h:column>
				  ...
				  <h:outputLink id="blaheoru13" 
									 value="#{summaryBean.resultsBean.stdoutUrl}" target="_blank">
