				  ...
				  <div id="Plot-Parameters" style="display:none;">
					 <table>
						<tr>
						  <td>
						  <b>Start Lat:</b>
						  <input type="text" name="startLat" id="startLat-value" size="12" value="" onchange="sarselect.updateStartLat()"/>
						  <b>Start Lon:</b>
						  <input type="text" name="startLon" id="startLon-value" size="12" value="" onchange="sarselect.updateStartLon()"/>
						  </td>
						</tr>
						<tr>
						  <td>
						  <b>End Lat:</b>
						  <input type="text" name="endLat" id="endLat-value" size="12" value="" onchange="sarselect.updateEndLat()"/>
						  <b>End Lon:</b>
						  <input type="text" name="endLon" id="endLon-value" size="12" value="" onchange="sarselect.updateEndLon()"/>
						  </td>
						</tr>
						<tr>
						  <td>
