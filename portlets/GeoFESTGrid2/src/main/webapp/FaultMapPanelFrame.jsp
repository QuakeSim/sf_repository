...
<script language="JavaScript">
	...
	var faultMap=null;
	faultMap=new GMap2(document.getElementById("geofest-faultMap"));
	...
	exmlFMap = new EGeoXml("exmlFMap", faultMap, kmllist, {sidebarfn:myside,nozoom:true,sidebarid:"geofest-faultMapside",iwwidth:200});       
	exmlFMap.parse();
	...
	var faultField=document.getElementById("geofest-faultKMLSelectorForm:faultName");
	GEvent.addDomListener(faultField,"click",function(param1,param2,param3,param4){
					...
					var newElement1=document.getElementById("geofest-faultKMLSelectorForm:faultName");
	 ...
	 function myside(myvar,name,type,i,graphic) {
				if(type=="polyline" || type=="polygon") {
					...
					var message=document.getElementById("geofest-faultKMLSelectorForm:messageBox");
