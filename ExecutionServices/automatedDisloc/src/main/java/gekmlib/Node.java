...
abstract public class Node implements Cloneable
{
	...
	if(this.parent!=null) // only recurse if we haven't already, and parent's not null
	{
	...
	if (this.deletedNodes != null)
	{
		...
		delete.append("<"+newNode.getClass().getSimpleName()+" targetId=\"" + ((ObjectNode)newNode).getId() + "\"></>\n");
	    }
