...
public class SimpleXDataKmlServiceLocator extends org.apache.axis.client.Service implements cgl.webservices.simplex.SimpleXDataKmlService {
    ...
    public cgl.webservices.simplex.SimpleXDataKml getKmlGenerator() throws javax.xml.rpc.ServiceException {
    ...
    public cgl.webservices.simplex.SimpleXDataKml getKmlGenerator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cgl.webservices.simplex.KmlGeneratorSoapBindingStub _stub = new cgl.webservices.simplex.KmlGeneratorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cgl.webservices.simplex.SimpleXDataKml.class.isAssignableFrom(serviceEndpointInterface)) {
                cgl.webservices.simplex.KmlGeneratorSoapBindingStub _stub = new cgl.webservices.simplex.KmlGeneratorSoapBindingStub(new java.net.URL(KmlGenerator_address), this);
                _stub.setPortName(getKmlGeneratorWSDDServiceName());
                return _stub;
            }
        }
