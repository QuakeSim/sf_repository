...
public class QueueServiceServiceLocator extends org.apache.axis.client.Service implements cgl.webservices.geofest.QueueServiceService {
    ...
    private java.lang.String QueueExec_address = "http://localhost:8080/queueservice/services/QueueExec";
    ...
    public cgl.webservices.geofest.QueueService getQueueExec(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cgl.webservices.geofest.QueueExecSoapBindingStub _stub = new cgl.webservices.geofest.QueueExecSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cgl.webservices.geofest.QueueService.class.isAssignableFrom(serviceEndpointInterface)) {
                cgl.webservices.geofest.QueueExecSoapBindingStub _stub = new cgl.webservices.geofest.QueueExecSoapBindingStub(new java.net.URL(QueueExec_address), this);
                _stub.setPortName(getQueueExecWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8080/queueservice/services/QueueExec", "QueueServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8080/queueservice/services/QueueExec", "QueueExec"));
        }
