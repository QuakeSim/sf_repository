/**
 * Slightly modified from apache source.
 */
...
/**
 * Modified so that System.exit is not called on completion since this
 * kills Tomcat.
 */
public class MyMain {
    static Logger logger=Logger.getLogger(MyMain.class);
    ...
    public static void start(String[] args,Properties additionalUserProperties,
                             ClassLoader coreLoader) throws AntServiceException {
        MyMain m = null;
	checkargs(args,"start");
	    ...
	    if(args!=null) {
            ...
            printMessage(exc);
            throw new AntServiceException(exc.toString());
        }
	    ...
	    throw new AntServiceException(be.toString());
	    //            System.exit(1);
        } catch (Throwable exc) {
            exc.printStackTrace();
            printMessage(exc);
...
// 	}
     ...
     *                           or is a directory.
     */
    protected MyMain(String[] args) throws BuildException {
    ...
    public static synchronized String getAntVersion() throws BuildException {
        if (antVersion == null) {
            try {
                Properties props = new Properties();
                InputStream in =
                    MyMain.class.getResourceAsStream("/org/apache/tools/ant/version.txt");
                props.load(in);
                in.close();
    ...
    private static void printTargets(Project project, boolean printSubTargets) {
        ...
        printTargets(project, topNames, topDescriptions, "MyMain targets:",
                     maxLength);
