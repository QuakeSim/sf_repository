 ...
 */ 
public class MyMain2 implements AntMain { 
    static Logger logger=Logger.getLogger(MyMain2.class);
    ...
    public static void start(String[] args, Properties additionalUserProperties, 
                             ClassLoader coreLoader) throws Exception{ 
        MyMain2 m = new MyMain2(); 
     ...
     * @deprecated 
     */ 
    protected MyMain2(String[] args) throws BuildException { 
        processArgs(args); 
    } 
    ...
    public static synchronized String getAntVersion() throws BuildException { 
        if (antVersion == null) { 
            try { 
                Properties props = new Properties(); 
                InputStream in = 
                    MyMain2.class.getResourceAsStream("/org/apache/tools/ant/version.txt"); 
                props.load(in); 
                in.close(); 
