...
public class GeoFESTService extends AntVisco implements Runnable{    
    ...
    public GeoFESTService() throws Exception{
	  ...
	  */
	 public void runBlockingMeshGenerator(){
	 }
	  ...
	  */
	 public void runNonBlockingMeshGenerator(){
	 }
	...
	String[] args=new String[16];
        ...
        args[3]="-DGeoFESTBaseName.prop="+projectName;
     ...
     */
    public String[] runNonblockingGeoFEST(String siteCode,
													  String beginDate,
													  String endDate,
													  int numModelStates)
		  throws Exception {
		  try {
				...
				return runNonblockingGeoFEST(dataUrl,numModelStates);
		  }
		  catch (Exception ex) {
				ex.printStackTrace();
				throw new Exception();
     ...
     * the data from the SOPAC data service.
     */
    public String[] runBlockingGeoFEST(String siteCode,
												  String beginDate,
												  String endDate,
												  int numModelStates)
		  throws Exception {
		  try {
				String dataUrl=querySOPACGetURL(siteCode,beginDate,endDate);
				return runBlockingGeoFEST(dataUrl,numModelStates);
		  }
		  catch (Exception ex) {
				ex.printStackTrace();
				throw new Exception();
    ...
    public String[] runBlockingGeoFEST(String inputFileUrlString,
												  int numModelStates) 
		  throws Exception {
		  ...
		  String[] returnVals=runBlockingGeoFEST(inputFileUrlString,
															 baseWorkDir,
															 outputDestDir,
															 projectName,
															 binPath,
     ...
     */
    public String[] runNonblockingGeoFEST(String inputFileUrlString,
													  int numModelStates) 
		  throws Exception {
		  ...
		  String[] returnVals=runNonblockingGeoFEST(inputFileUrlString,
																 baseWorkDir,
																 outputDestDir,
																 projectName,
																 binPath,
     ...
     * GeoFEST finished executing.  This is the full API.
     */
    public String[] runBlockingGeoFEST(String inputFileUrlString,
												  String baseWorkDir,
												  String outputDestDir,
    ...
    public static void main(String[] args) {
		  ...
		  try {
				...
				GeoFESTService rds=new GeoFESTService(true);
				System.out.println("----------------------------------");
				System.out.println("Testing blocking version");
				rds.runBlockingGeoFEST(dataUrl,
											 numModelStates);
				
				System.out.println("----------------------------------");
				System.out.println("Testing non-blocking version");
				rds.runNonblockingGeoFEST(dataUrl,
												 numModelStates);
		  }
		  catch (Exception ex) {
				ex.printStackTrace();
