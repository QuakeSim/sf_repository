      ...
      if ($1==3)
      plot "$0" using ($$2):($$1==line_style ? $$3 : 1/0) with lines linetype line_style;
      if ($1==4)
      plot "$0" using ($$2):($$1==line_style ? $$4 : 1/0) with lines linetype line_style;
      if ($1==5)
      plot "$0" using ($$2):($$1==line_style ? $$5 : 1/0) with lines linetype line_style;
