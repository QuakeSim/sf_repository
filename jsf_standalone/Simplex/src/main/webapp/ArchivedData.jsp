			...
			<h:dataTable border="1" value="#{SimplexBean.myarchivedFileEntryList}"
				...
				<h:column>
					...
					<h:panelGrid columns="3" border="1">
						...
						<h:outputLink id="link1" value="#{facesContext.externalContext.requestContextPath}/DownloadDataFile.jsp" target="_blank">
							...
							<f:param name="fileServiceUrl" value="#{SimplexBean.fileServiceUrl}" />

							<h:outputText value="input" />
						</h:outputLink>
						<h:outputLink id="link2" value="#{facesContext.externalContext.requestContextPath}/DownloadDataFile.jsp" target="_blank">
							<f:param name="ProjectSelect" value="#{myentry3.projectName}" />
						...
						<h:outputLink id="link3" value="#{facesContext.externalContext.requestContextPath}/DownloadDataFile.jsp" target="_blank">
							<f:param name="ProjectSelect" value="#{myentry3.projectName}" />
