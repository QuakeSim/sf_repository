...
<html>
    ...
    <body>
	 ...
	 <h:outputText value="End Date"/>
         ...
         <h:outputText value="(YYYY-MM-DD)"/>
       <h:message for="enDate" showDetail="true" showSummary="true" errorStyle="color: red"/>
         </h:panelGrid>
         </h:panelGrid>
	 ...
	 <h:outputText value="Resource"/>
         <h:selectOneListbox title="Resource:"
	                     ...
	                     size="1">
            <f:selectItem  value="#{rdahmmBean.resource}"
	 ...
	 <h:outputText value="Context Group"/>
         <h:selectOneListbox title="Context Group"
			     value="#{rdahmmBean.contextGroup}"
	                     size="1">
	     <f:selectItem  value="#{rdahmmBean.contextGroup}"
                            itemValue="reasonComb" 
                            itemLabel="REASoN combination"/>
	     <f:selectItem  value="#{rdahmmBean.resource}" itemValue="sopacGlobk" itemLabel="SOPAC GLOBK"/>
	     <f:selectItem  value="#{rdahmmBean.resource}" itemValue="jplGipsy" itemLabel="JPL GIPSY"/>
	     <f:selectItem  value="#{rdahmmBean.resource}" itemValue="usgsGlobk" itemLabel="USGS GLOBK"/>
         </h:selectOneListbox>
         </h:panelGrid>
