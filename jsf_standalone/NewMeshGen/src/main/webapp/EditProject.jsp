...
>
	...
	<h:panelGrid rendered="#{!empty MGBean.projectMeshRunBean}">
	<h:outputText escape="false" value=" <h2>Mesh Refinement</h2>"/>
	<h:outputText value="Your mesh has been created.  To view output, click the links below.  To see a 
	...
	<h:form>
		<h:panelGrid columns="12" border="0">
			<h:panelGroup>
  				<h:dataTable value="#{MGBean.projectMeshRunBean}" var="mrb" id="MeshOutputPanel" border="1">
					<h:column>
					    <f:facet name="header">
					...
					<f:facet name="header">
				       ...
				       <h:outputLink value="#{mrb.junkBox}" target="_blank">
						    <h:outputText value="junkBox"/>
						 </h:outputLink>
					</h:column>
					...
					<f:facet name="header">
				       ...
				       <h:outputLink value="#{mrb.tstout}" target="_blank">
						    <h:outputText value="Tstout URL"/>
						 </h:outputLink>
					</h:column>
