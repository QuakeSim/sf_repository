	...
	<h:form>
  				...
  				<h:dataTable value="#{MGBean.myArchivedMeshRunList2}"					  
					...
					<f:facet name="header">
				       ...
				       <h:outputLink value="#{mrb.gfOutputBean.cghistUrl}" target="_blank">
						    <h:outputText value="CG Hist File"/>
						 </h:outputLink>
					</h:column>
					...
					<f:facet name="header">
				       ...
				       <h:outputLink value="#{mrb.gfOutputBean.inputUrl}" target="_blank">
						    <h:outputText value="Input File"/>
						 </h:outputLink>
					</h:column>
					...
					<f:facet name="header">
				       ...
				       <h:outputLink value="#{mrb.gfOutputBean.outputUrl}" target="_blank">
						    <h:outputText value="Output File"/>
						 </h:outputLink>
					</h:column>
					...
					<f:facet name="header">
				       ...
				       <h:outputLink value="#{mrb.gfOutputBean.logUrl}" target="_blank">
						    <h:outputText value="Log File"/>
						 </h:outputLink>
					</h:column>
					...
					<f:facet name="header">
				       ...
				       <h:outputLink value="#{mrb.gfOutputBean.tarOfEverythingUrl}" target="_blank">
						    <h:outputText value="Project Tar"/>
						 </h:outputLink>
					</h:column>
