...
<body>
<h2>QuakeSim2 Disloc2 Gadget</h1>
...
<iframe scrolling="yes" width=100% height="700" onLoad="calcHeight();" frameborder="1" src="http://156.56.104.158:8080//Disloc2/LoadProject.faces?email=<%=session.getAttribute("email")%>"></iframe>
</div>

<div id="TabDiv2" name="TabDiv2" style="display:none">
<iframe scrolling="yes" width=100% height="700" onLoad="calcHeight();" frameborder="1" src="http://156.56.104.158:8080//Disloc2/FetchResults.faces?email=<%=session.getAttribute("email")%>"></iframe>
</div>


<div id="TabDiv3" name="TabDiv3" style="display:none">
<iframe scrolling="yes" width=100% height="700" onLoad="calcHeight();" frameborder="1" src="http://156.56.104.158:8080//Disloc2/LocateProject.faces?email=<%=session.getAttribute("email")%>"></iframe>
</div>
