...
%>
	...
	function overlayMarkersBody(){        	
		...
		if (showDateStr != "") {
			...
			url = "http://156.56.104.158:8080/axis2/services/DailyRdahmmResultService/calcStationColors?date=" + showDateStr + "&resUrl=" + xmlResultUrl;
	...
	var url = "http://156.56.104.158:8080/axis2/services/DailyRdahmmResultService/getDataLatestDate?resUrl=" + xmlResultUrl;
