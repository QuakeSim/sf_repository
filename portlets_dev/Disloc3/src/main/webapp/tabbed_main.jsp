...
<iframe scrolling="yes" width=100% height="700" frameborder="1" src="@host.base.url@/Disloc3/LoadProject.faces?email=<%=session.getAttribute("email")%>"></iframe>
</div>

<div id="TabDiv2" name="TabDiv2" style="display:none">
<iframe scrolling="yes" width=100% height="700" frameborder="1" src="@host.base.url@/Disloc3/FetchResults.faces?email=<%=session.getAttribute("email")%>"></iframe>
</div>


<div id="TabDiv3" name="TabDiv3" style="display:none">
<iframe scrolling="yes" width=100% height="700" frameborder="1" src="@host.base.url@/Disloc3/LocateProject.faces?email=<%=session.getAttribute("email")%>"></iframe>
</div>
