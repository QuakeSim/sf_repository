...
<body>
<h2>QuakeSim2 Simplex Gadget</h1>
...
<iframe scrolling="yes" width=100% height="700" onLoad="calcHeight();" frameborder="1" src="http://156.56.104.158:8080//Simplex-portlet/ArchivedData.faces?email=<%=session.getAttribute("email")%>"></iframe>
</div>


<div id="TabDiv3" name="TabDiv3" style="display:none">
<iframe scrolling="yes" width=100% height="700" onLoad="calcHeight();" frameborder="1" src="http://156.56.104.158:8080//Simplex-portlet/PlotGrid.faces?email=<%=session.getAttribute("email")%>"></iframe>
</div>
