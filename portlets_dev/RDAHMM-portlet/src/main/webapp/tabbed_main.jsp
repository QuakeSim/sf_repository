...
<body>
<h2>QuakeSim2 RDAHMM Gadget</h1>
<ul id="countrytabs" class="shadetabs">
<li><a href="javascript:TapAcess('1')" rel="TabDiv">allstations</a></li>
<li><a href="javascript:TapAcess('2')" rel="TabDiv">FetchResults</a></li>

</ul>

<div id="TabDiv1" name="TabDiv1" style="display:none">
<iframe scrolling="yes" width=100% height="700" onLoad="calcHeight();" frameborder="1" src="http://156.56.104.158:8080//RDAHMM-portlet/allstations.faces?email=<%=session.getAttribute("email")%>"></iframe>
</div>

<div id="TabDiv2" name="TabDiv2" style="display:none">
<iframe scrolling="yes" width=100% height="700" onLoad="calcHeight();" frameborder="1" src="http://156.56.104.158:8080//RDAHMM-portlet/FetchResults.faces?email=<%=session.getAttribute("email")%>"></iframe>
</div>
